<div class="flex justify-between items-center mb-4 mt-3">
    ...
    <p class="px-4 text-gray-500 text-sm">
        Menampilkan catatan semua pembelian produk dari pemasok, termasuk detail dan tanggal transaksi.
    </p>
    </div>
...
<div class="overflow-x-auto bg-white shadow-md rounded-md mb-6">
    <table class="min-w-full">
        <thead class="bg-[#092363] text-white">
            <tr>
                <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Tanggal & Waktu</th>
                <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Barang</th>
                <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Category</th>
                <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Method</th>
                ...
                <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Location</th>
                <th class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider">Keterangan / Ref</th>
            </tr>
        </thead>
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-3 text-sm text-gray-600">Elektronik</td>
                <td class="px-6 py-3 text-center">
                    <span class="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-bold">Dana</span>
                </td>
                <td class="px-6 py-3 text-center font-bold text-green-600">10</td>
                <td class="px-6 py-3 text-sm text-gray-600">Staff A</td>
                <td class="px-6 py-3 text-sm text-gray-600">Rak 001</td>
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-3 text-sm text-gray-600">Furniture</td>
                <td class="px-6 py-3 text-center">
                    <span class="bg-fuchsia-100 text-fuchsia-700 px-2 py-1 rounded text-xs font-bold">OVO</span>
                </td>
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-3 text-sm text-gray-600">Furniture</td>
                <td class="px-6 py-3 text-center">
                    <span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-bold">Mandiri</span>
                </td>
